    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[420px] p-0 gap-0 bg-[#FAFAF8] border-[#E6E6E6]">
        ...
        <div className="p-5 space-y-3">
          <div className="flex items-center justify-between p-4 rounded-lg border border-[#E6E6E6] bg-white hover:bg-[#FAFAF7] transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: '#91918D' }}>Connect your Gmail account</p>
              </div>
            </div>
            <Button 
              variant="outline" 
              size="sm" 
              className="border-[#E6E6E6] hover:bg-[#F0F0EB] hover:border-[#CC785C]"
              style={{ color: '#333333' }}
            >
              Connect
            </Button>
          ...
          <div className="flex items-center justify-between p-4 rounded-lg border border-[#E6E6E6] bg-white hover:bg-[#FAFAF7] transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: '#91918D' }}>Connect your Outlook account</p>
              </div>
            </div>
            <Button 
              variant="outline" 
