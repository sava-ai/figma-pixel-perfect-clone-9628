...
// PriceMind Job Criteria based on /joboffer:
// Core: Sales mentality, B2B lead gen, 1-3 yrs digital sales, CRM experience, Fluent English, Digital solutions selling
// Soft: International/European clients, Pricing tools understanding, Distribution/Manufacturing knowledge
...
export const bestCandidates: Candidate[] = [
  {
    ...
    summary: "Driven BD Specialist with 3+ years in lead generation and B2B SaaS sales. Multilingual (EN, UA, PL, ES) with strong relationship-building skills. Experience at SALESmanago demonstrates CRM and marketing automation expertise relevant to pricing software sales.",
    skillTags: ['Lead Generation', 'B2B SaaS', 'CRM Tools'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
      { icon: 'globe', label: 'Fluent English Communication', status: 'full', required: true },
    ],
    softSkills: [
      { icon: 'users', label: 'International/European Clients', status: 'full', required: false },
      { icon: 'building', label: 'Distribution/Manufacturing Knowledge', status: 'partial', required: false },
    ],
  ...
  },
  {
    ...
    summary: "BDM with IT outsourcing expertise. Strong track record in client acquisition and sales pipeline development. Technical background enables consultative selling of complex software solutions.",
    skillTags: ['IT Sales', 'Business Development', 'Client Relationships'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'partial', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
      { icon: 'globe', label: 'Fluent English Communication', status: 'full', required: true },
    ],
    softSkills: [
      { icon: 'users', label: 'International/European Clients', status: 'full', required: false },
      { icon: 'building', label: 'Distribution/Manufacturing Knowledge', status: 'none', required: false },
    ],
  ...
  },
  {
    ...
    summary: "Account Executive with Google BDR background. Expert in consultative selling of digital solutions. Multilingual (IT, PL, EN, DE, ES) enables effective communication with senior managers across CEE region.",
    skillTags: ['Account Management', 'Consultative Selling', 'Digital Solutions'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
  ...
  },
  {
    ...
    summary: "High-performing IT Sales Specialist with 108% quota achievement. Strong Salesforce and HubSpot expertise. Marketing background enables effective positioning of pricing software to enterprise clients. Goal-oriented with proven digital sales results.",
    skillTags: ['Enterprise Software', 'SaaS Sales', 'Pipeline Management'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
    ...
    softSkills: [
      { icon: 'users', label: 'International/European Clients', status: 'full', required: false },
      { icon: 'building', label: 'Distribution/Manufacturing Knowledge', status: 'full', required: false },
    ],
  ...
  },
  {
    ...
    summary: "SDR at Akamai focused on enterprise security solutions. Experience in complex B2B sales cycles. Strong in strategic partnerships and pipeline development, though limited exposure to pricing or manufacturing sectors.",
    ...
    softSkills: [
      { icon: 'users', label: 'International/European Clients', status: 'partial', required: false },
      { icon: 'building', label: 'Distribution/Manufacturing Knowledge', status: 'none', required: false },
    ],
  ...
  },
  {
    ...
    summary: "Senior SDR with rapid career progression at PinMeTo SaaS. Demonstrated ability to grow within organization and exceed targets. Strong in digital lead generation and client development.",
  ...
  },
  {
    ...
    summary: "BDM at Nielsen with data and analytics expertise. Technical background combined with sales excellence. Experience selling to large enterprises makes him well-suited for pricing software conversations with senior managers.",
    skillTags: ['Marketing Data', 'Analytics', 'Account Management'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
  ...
  },
  {
    ...
    summary: "BDM with 4+ years in B2B sales. Strong CRM expertise and proven career growth within organizations. Goal-oriented mindset with experience across CEE region. Located in Lithuania with openness to remote/hybrid.",
  ...
  },
  {
    ...
    summary: "Senior Sales Executive with Shopify and Acronis experience. Expert in enterprise solutions and customized sales strategies. ExxonMobil background provides valuable distribution sector knowledge.",
    skillTags: ['Enterprise Solutions', 'E-commerce', 'Distribution'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
  ...
  },
  {
    ...
    summary: "Sales Account Manager with 4 years in tech services. Strong project management skills enable effective coordination of complex sales cycles. Experience selling digital solutions to enterprise clients.",
  ...
  },
  {
    ...
    summary: "BD Account Manager with digital marketing expertise. Strong analytical background in aviation tech. Experience at StorkJet selling optimization software to airlines provides relevant SaaS sales experience for pricing solutions.",
    skillTags: ['Digital Marketing', 'Google Ads', 'B2B SaaS'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
  ...
  },
  {
    ...
    summary: "BDR focused on digital transformation and IT solutions. Strong presentation skills and customer acquisition expertise. Currently studying management at Kozminski - Poland's top business school.",
  ...
  },
  {
    ...
    summary: "Entrepreneur with 4+ years in SaaS sales and account management. Strong Salesforce expertise and startup experience. Entrepreneurial mindset aligns with PriceMind's need for self-driven individuals.",
  ...
  },
  {
    ...
    summary: "SDR at Pretius with focus on custom software and Low-code solutions. Strong in digital transformation sales. AI Labs partnership shows technical understanding beneficial for selling pricing software.",
  ...
  },
  {
    ...
    summary: "SDR with MBA background and strong project development skills. Experience in market research and account planning. MBA from German university provides excellent foundation for enterprise sales.",
  ...
  },
  {
    ...
    summary: "BDM with IT outsourcing expertise. Full-cycle sales experience with focus on mentoring and automation. Strong in independent work and taking initiative on lead generation.",
  ...
  },
  {
    ...
    summary: "Microsoft Sales Specialist with KAM experience. SGH education provides strong business foundation. Wipasz experience in food distribution sector aligns with PriceMind's manufacturing/distribution focus.",
  ...
  },
  {
    ...
    summary: "AE & Partnerships Lead with strong marketing operations background. Data-driven approach with HubSpot expertise. TÜV SÜD experience provides industrial/manufacturing sector knowledge.",
  ...
  },
  {
    ...
    summary: "BDM at ONIX Consulting with IT outsourcing expertise. Strong enterprise client acquisition skills. Experience communicating with C-level executives in large corporations.",
  ...
  },
  {
    ...
    summary: "BDM with Chinese market expertise. Unique ability to bridge Western and Eastern business practices. While PriceMind focuses on CEE, cross-cultural skills are valuable for international growth.",
    skillTags: ['Chinese Market', 'Cross-cultural', 'Presentations'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'partial', required: true },
      { icon: 'globe', label: 'Fluent English Communication', status: 'full', required: true },
    ],
    softSkills: [
      { icon: 'users', label: 'International/European Clients', status: 'partial', required: false },
  ...
  },
  {
    ...
    match: "9/12",
    isNew: false,
    description: "Google Ads Strategist with SaaS business development experience. Strong background in cloud technology and automotive/electronics sectors.",
    roles: [
      { company: "Iwasoft", role: "Google Ads Strategist" },
      { company: "Iwasoft", role: "SaaS BD Specialist" }
    ],
    currentRoleIndex: 0,
    engagementRate: 83,
    tags: ['AI sourced'],
    ...
    summary: "Google Ads strategist with SaaS BD experience. Strong in cloud technology and automotive/electronics sectors provides relevant manufacturing industry knowledge.",
  ...
  },
  {
    ...
    summary: "KAM with B2B and B2C sales expertise. Strong negotiation and cross-selling skills in IT sector. AutoFus Group experience provides automotive/distribution sector knowledge.",
  ...
  },
  {
    ...
    summary: "Sales Development Specialist with strong inside sales background. Experience in EdTech and B2B sectors. Growing experience in European markets.",
  ...
  },
  {
    ...
    summary: "SDR with 4+ years in healthcare tech and SaaS. Strong career progression and cold calling expertise. User.com experience demonstrates ability to sell marketing automation platforms.",
  ...
  },
  {
    ...
    summary: "Microsoft Partner Marketing Specialist with 4+ years. Strong strategy development and partner management skills. AB S.A. distribution experience highly relevant for PriceMind's target sectors.",
    skillTags: ['Microsoft', 'Partner Marketing', 'Distribution'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
  ...
  },
  {
    ...
    summary: "SDR with international business background. Multilingual with strong analytical and financial skills. Limited experience but strong educational foundation.",
    skillTags: ['International Business', 'Analytics', 'Multilingual'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'none', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'partial', required: true },
      { icon: 'globe', label: 'Fluent English Communication', status: 'full', required: true },
    ],
    softSkills: [
  ...
  },
  {
    ...
    summary: "Account Executive at Vonage with strong outbound/inbound sales skills. Target-driven with exceptional English. Growing in B2B SaaS sales.",
  ...
  },
  {
    ...
    summary: "SDR with software development sales expertise. Experience in startup and SMB sectors. Technical understanding beneficial for pricing software conversations.",
  ...
  },
  {
    ...
    summary: "B2B Manager with 4 years experience across fintech and digital marketing. Strong CRM and lead nurturing expertise. Proven ability to work independently and manage sales processes.",
  ...
  },
  {
    ...
    summary: "EMEA BDR at Salesforce partner. Expertise in CRM implementation, consulting and training. Deep Salesforce knowledge directly relevant to PriceMind's Pricefx integration work.",
    ...
    softSkills: [
      { icon: 'users', label: 'International/European Clients', status: 'full', required: false },
      { icon: 'sparkles', label: 'Understanding of Pricing Tools', status: 'full', required: false },
    ],
  ...
  },
  {
    ...
    summary: "SDR in real estate tech with strong relationship building skills. Multilingual with innovation focus. Growing experience in B2B SaaS sales.",
  ...
  },
  {
    ...
    summary: "SDR with strategic management background from RSM. Experience in opportunity analysis and consulting. KPMG/Genpact experience provides strong foundation for enterprise sales.",
    ...
    linkedin: "https://www.linkedin.com/in/diana-negrea-92b6b119a",
  },
  {
    id: 33,
    name: "Ekemini Udosen",
    ...
    summary: "SDR/AE at Vonage with telecommunications expertise. Growing in cloud communications sales. Limited experience but strong potential.",
  ...
  },
  {
    ...
    summary: "BD Executive with inside sales and export experience. Trilingual (PL, DE, EN) with automotive sector background. LRT Automotive experience provides manufacturing industry knowledge.",
  ...
  },
  {
    ...
    summary: "SDR Sales Operations with nearly 4 years BD experience. Strong relationship building and sales process optimization. Experience managing full sales operations cycle.",
  ...
  },
  {
    ...
    summary: "Junior Sales Rep at Euvic Solutions. Customer service background with technical aptitude. Growing in IT solutions sales.",
  ...
  },
  {
    ...
    summary: "Inside Sales AM at Aptean with supply chain and AI expertise. Strong B2B SaaS account management skills. Aptean's ERP focus provides excellent background for pricing software sales to manufacturing/distribution.",
    skillTags: ['Supply Chain Tech', 'AI Solutions', 'ERP'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
  ...
  },
  {
    ...
    summary: "BDR at Snoika with strong inbound lead generation. AIESEC leadership experience demonstrates ability to take initiative and work independently.",
  ...
  },
  {
    ...
    summary: "Google Account Strategist with Revolut and Glovo experience. Strong B2B/B2C and fintech expertise. Excellent track record at top tech companies demonstrates ability to sell to enterprise clients.",
  ...
  },
  {
    ...
    summary: "BDR with 3+ years and strong technical background. Experience in software development sales across multiple technologies. Technical depth enables consultative selling of complex solutions.",
  ...
  },
  {
    ...
    summary: "Pre-Sales Engineer at Creatio with BDR background. Strong in business process automation and CRM solutions. Creatio experience highly relevant for pricing software implementations.",
  ...
  },
  {
    ...
    summary: "SDR at Unity Finance with fintech experience. Strong business/commerce educational background. Limited B2B SaaS experience.",
  ...
  },
  {
    ...
    summary: "Account Executive at AppMagic with digital marketing expertise. Strong strategic thinking skills. Language background enables effective communication across European markets.",
  ...
  },
  {
    ...
    roles: [
      ...
      { company: "Cortex Chemicals", role: "Product Manager" }
    ],
    currentRoleIndex: 0,
    engagementRate: 80,
    tags: ['Referred'],
    ...
    summary: "SDR at Salesbook with product management background. Cortex Chemicals experience provides manufacturing/chemical industry knowledge relevant to PriceMind's target sectors.",
    skillTags: ['Commercial Sales', 'Product Management', 'Chemicals'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'partial', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
  ...
  },
  {
    ...
    summary: "BDR at GamerSEO with project management background. Experience in B2B/B2C sales and digital marketing. Results-driven approach aligns with sales mentality requirements.",
  ...
  },
  {
    ...
    summary: "Microsoft EMEA Partner GTM Lead. Strong in partner strategy and ISV ecosystem. Senior experience may exceed role scope but brings valuable strategic perspective.",
  ...
  },
  {
    ...
    summary: "Sales Manager with 4+ years and engineering background. MBA candidate with strong technical sales skills. VPP Energy experience in B2B energy sector highly relevant.",
  ...
  },
  {
    ...
    summary: "New Business Manager at edrone with real estate background. Strong in marketing strategy and social media. edrone e-commerce automation experience relevant to retail pricing.",
    skillTags: ['New Business', 'Real Estate', 'Marketing Strategy'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
      { icon: 'globe', label: 'Fluent English Communication', status: 'partial', required: true },
    ],
    softSkills: [
      { icon: 'users', label: 'International/European Clients', status: 'partial', required: false },
      { icon: 'building', label: 'Distribution/Manufacturing Knowledge', status: 'partial', required: false },
  ...
  },
  {
    ...
    summary: "Account Executive at Vonage with international relations background. Strong organizational and event planning skills. 3+ years in communications/tech sales.",
    skillTags: ['Account Executive', 'International Relations', 'Communications'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
  ...
  },
  {
    ...
    summary: "Alibaba Global Business Consultant with B2B e-commerce expertise. Strong finance background and international experience. Zhejiang Jiyan Transmission provides manufacturing sector knowledge.",
    skillTags: ['B2B E-commerce', 'Alibaba', 'Manufacturing'],
    coreCriteria: [
      { icon: 'briefcase', label: 'B2B Lead Generation Experience', status: 'full', required: true },
      { icon: 'clock', label: '1-3 Years Digital Sales', status: 'full', required: true },
      { icon: 'code', label: 'CRM & Sales Tools (HubSpot, Salesforce)', status: 'full', required: true },
