      ...
      <ResizablePanelGroup direction="horizontal" className="flex-1 overflow-hidden">
        ...
        <ResizablePanel defaultSize={isChatCollapsed ? 100 : 65} minSize={30}>
          <div className="h-full flex flex-col py-6 pb-8 relative" style={{ backgroundColor: '#FAF8F4' }}>
            <div className={`flex-1 overflow-y-auto bg-background rounded-[15px] p-12 relative ${isChatCollapsed ? 'mx-6' : 'ml-6 mr-2.5'}`}>
              {/* AI Suggestions Tracker - Inside job description at top */}
