          ...
          <div className="h-full flex flex-col py-4 pb-6 relative" style={{ backgroundColor: '#FAF8F4' }}>
            <div className={`flex-1 overflow-y-auto bg-background rounded-[15px] relative ${isChatCollapsed ? 'mx-4' : 'ml-4 mr-2'}`}>
              <div className="h-full flex flex-col justify-center px-8 py-6 gap-4">
                ...
                {/* External Sources */}
                {showExternalSources && (
                <div className="rounded-xl p-5 animate-fade-in" style={{ backgroundColor: '#FAF8F4' }}>
                  ...
                  <div className="relative overflow-hidden h-16">
                    <div className="flex gap-4 animate-scroll absolute whitespace-nowrap">
                      <div className="flex gap-4 items-center">
                        ...
                        {/* GitHub */}
                        <div className="w-10 h-10 rounded-lg bg-[#181717] flex items-center justify-center shadow-sm">
                          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="white">
                        ...
                        {/* Dribbble */}
                        <div className="w-10 h-10 rounded-lg bg-[#ea4c89] flex items-center justify-center shadow-sm">
                          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="white">
                        ...
                        {/* Behance */}
                        <div className="w-10 h-10 rounded-lg bg-[#0057FF] flex items-center justify-center shadow-sm">
                          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="white">
                ...
                <div className="rounded-xl p-5 animate-fade-in" style={{ backgroundColor: '#FAF8F4' }}>
                  ...
                  <div className="flex gap-3 justify-center">
                    <div className="flex items-center gap-2 px-5 py-1.5 bg-white rounded-lg text-sm font-medium shadow-sm">
                ...
                <div className="rounded-xl p-5 animate-fade-in" style={{ backgroundColor: '#FAF8F4' }}>
                  ...
                  <div className="flex items-center justify-center gap-3">
                    <div className="flex -space-x-2">
                      <img src={profile2} alt="" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
                      <img src={profile3} alt="" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
                      <img src={profile4} alt="" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
                    </div>
                ...
                <div className="rounded-xl p-5 animate-fade-in" style={{ backgroundColor: '#FAF8F4' }}>
                  ...
                  <div className="flex flex-wrap gap-2 justify-center">
                    {bestMatches.slice(0, visibleMatches).map((match, index) => (
                      <div
                        key={index}
                        className="w-12 h-12 rounded-xl overflow-hidden animate-fade-in shadow-sm"
                        title={match.name}
                      >
