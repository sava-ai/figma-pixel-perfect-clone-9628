              ...
              {/* Header with stats - hide when profile is selected */}
                {!selectedBestMatch && (
                  <div className="mb-5 animate-slide-down-fade-in">
                    ...
                    <button
                      className="w-full bg-white border border-[#EEEDEC] rounded-xl py-6 px-6 text-left hover:bg-gray-50 transition-all group mb-4"
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <h2 className="font-hedvig text-lg font-semibold text-foreground">
                              Review and rating history
                            </h2>
                            <p className="text-sm text-muted-foreground">
                              View your past reviews and ratings for all candidates.
                            </p>
                          </div>
                        </div>
