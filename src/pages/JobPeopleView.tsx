                ...
                {!selectedBestMatch && (
                  <div className="mb-5 animate-slide-down-fade-in">
                    ...
                    <div className="flex gap-3 mb-4 pt-3">
                      {/* Applicants Card */}
                      <button 
                        className="flex-1 rounded-xl p-5 text-left hover:border-[#D9D9D9] transition-colors group"
                      ...
                      >
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <p className="text-foreground" style={{ fontFamily: 'CooperLight, sans-serif', fontSize: '1rem' }}>Applicants</p>
                        </div>
                        <p className="text-4xl font-medium mb-3" style={{ fontFamily: 'Inter, sans-serif', color: '#1A1A1A' }}>{applicantsCount}</p>
                      ...
                      >
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <p className="text-foreground" style={{ fontFamily: 'CooperLight, sans-serif', fontSize: '1rem' }}>Rejected</p>
                        </div>
                        <p className="text-4xl font-medium mb-3" style={{ fontFamily: 'Inter, sans-serif', color: '#1A1A1A' }}>{rejectionsCount}</p>
                        <div className="flex items-center gap-1 text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                          <span style={{ fontFamily: 'Inter, sans-serif' }}>Review now</span>
                          <ChevronRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                        </div>
                    ...
                    <div className="grid grid-cols-4 gap-3 mb-4">
                      ...
                      <button 
                        onClick={() => navigate('/job/pipeline')} 
                        className="rounded-xl p-5 text-left hover:border-[#D9D9D9] transition-colors group"
                        style={{ backgroundColor: '#FFFFFF', border: '1px solid #E6E6E6' }}
                      >
                        <div className="flex items-center gap-2 mb-3">
                          <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#CD785C' }}>
